    ...
    >
      ...
      <div className="container mx-auto px-6 text-center relative z-10">
        ...
        <p className="text-lg md:text-xl text-gray-300 max-w-3xl mx-auto mb-12 leading-relaxed">
          ...
          Currently focused on creating scalable web applications with{' '}
          <span className="text-accent-500 font-semibold">React</span>, {' '}
          <span className="text-accent-500 font-semibold">Node.js</span>, and{' '}
          <span className="text-accent-500 font-semibold">cloud technologies</span>.
        </p>
        ...
        <div className="flex flex-col sm:flex-row gap-6 justify-center items-center">
          <button
            ...
            className="group px-8 py-4 bg-transparent border-2 border-accent-500 text-accent-500 rounded text-lg font-mono transition-all duration-300 hover:bg-accent-500 hover:text-primary-900 transform hover:scale-105 hover:shadow-lg hover:shadow-accent-500/25"
          >
          ...
          <button
            ...
            className="group px-8 py-4 bg-accent-500 text-primary-900 rounded text-lg font-mono font-semibold transition-all duration-300 hover:bg-accent-600 hover:shadow-lg hover:shadow-accent-500/25 transform hover:scale-105"
          >
            <span className="flex items-center">
              Get In Touch
              <svg 
