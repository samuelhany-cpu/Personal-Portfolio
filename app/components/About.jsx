        ...
        <div className='max-w-6xl mx-auto'>
            ...
            >
              <div className='space-y-4 text-white leading-relaxed'>
                <p className='text-lg'>
                  ...
                  with over 3 years of experience creating digital solutions
                  that make a difference. My journey in web development started
                  with curiosity and has evolved into a love for crafting
                ...
                <p>
                  ...
                  <span className='text-accent-500'> Next.js</span>, combined
                  with robust backend technologies like
                  <span className='text-accent-500'> Node.js</span> and various
                  databases. I'm passionate about writing clean, maintainable
                ...
                <p>
                  ...
                  continuous learning and the power of collaboration to solve
                  complex problems.
                </p>
              </div>
          ...
          <div className='mt-20'>
            <h3 className='text-2xl md:text-3xl font-heading font-bold text-gray-100 text-center mb-12'>
              What I Bring to{' '}
              <span className='text-accent-500'>Your Project</span>
            </h3>
