  ...
  const FeaturedProject = ({ project, index, isReverse = false }) => {
    ...
    return (
      ...
      >
        ...
        {/* Project Content */}
        <div
          className={`space-y-6 ${isReverse ? 'lg:col-start-1 lg:text-right' : ''}`}
        >
          <div>
          ...
          <div className='bg-black p-6 rounded-lg border-2 border-white shadow-lg'>
          ...
          <div
            className={`flex flex-wrap gap-3 ${isReverse ? 'lg:justify-end' : ''}`}
          >
            {project.techStack &&
              project.techStack.map(tech => (
                <span
                  key={tech}
                  className='tech-tag text-sm font-mono'
                >
                  {tech}
                </span>
              ))}
          ...
          <div
            className={`flex space-x-6 ${isReverse ? 'lg:justify-end' : ''}`}
          >
            <a
              href={project.githubLink}
              target='_blank'
              rel='noopener noreferrer'
              className='text-white hover:text-accent-500 transition-colors duration-300 border border-gray-600 rounded-full p-2 hover:border-accent-500'
            >
      ...
      <div className='container mx-auto px-6 relative z-10'>
        ...
        <div className='text-center mb-20'>
          ...
          <p className='text-lg md:text-xl text-white max-w-3xl mx-auto'>
            ...
            development, modern frameworks, and scalable architecture.
          </p>
